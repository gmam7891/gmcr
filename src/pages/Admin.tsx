...
const ALL_TABS = [
  ...
  { id: "discovery", label: "Prospecção" },
  { id: "scanner", label: "Casino Scanner" },
  { id: "scanner_dashboard", label: "Scanner — Dashboard" },
  { id: "scanner_streamers", label: "Scanner — Streamers" },
  { id: "scanner_games", label: "Scanner — Jogos" },
  { id: "scanner_providers", label: "Scanner — Provedoras" },
  { id: "scanner_chat", label: "Scanner — Chat" },
  { id: "scanner_audit", label: "Scanner — Auditoria" },
  { id: "scanner_review", label: "Scanner — Revisão" },
  { id: "scanner_quality", label: "Scanner — Qualidade" },
  { id: "scanner_vod_quality", label: "Scanner — Qualidade VOD" },
  { id: "scanner_queue", label: "Scanner — Fila de Jobs" },
  { id: "scanner_ai_lab", label: "Scanner — AI Lab" },
  { id: "scanner_results", label: "Scanner — Resultados" },
];
