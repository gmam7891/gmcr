        ...
        <TableBody>
          {rankings.map((r, i) => (
            <TableRow key={r.key}>
              ...
              <TableCell className="text-right font-mono text-xs">{Math.round(r.exposure / 3600 * 10) / 10}h</TableCell>
              <TableCell className="text-right font-mono text-xs">{Math.round(r.viewer_minutes / 1000)}k</TableCell>
              <TableCell className="text-right font-mono text-xs">{r.sessions}</TableCell>
              <TableCell className="text-right font-mono text-xs">{r.peak.toLocaleString()}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
